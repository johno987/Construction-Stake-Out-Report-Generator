        ...
        try
        {
            ...
            var doc = Document.Create(document =>
            {
                document.Page(page =>
                {
                    ...
                    page.Header()
                        ...
                        .Row(row =>
                        {
                            ...
                            row.RelativeItem()
                                ...
                                .PaddingRight(10)
                                .Text(
                                    DefineErrorCheckBox.Checked
                                        ? $"Defined Tolerance: {DefinedErrorTolerance}m"
                                        : "Defined Tolerance: N/A"
                                )
                                .Bold()
                                .Underline()
                                .FontSize(15);
                                ...
                                .Table(table =>
                                {
                                    ...
                                    table.Header(header =>
                                    {
                                        ...
                                        header
                                            .Cell()
                                            .Element(BlockHeader)
                                            .Text(Error2DCheckBox.Checked ? "2D Error" : "3D Error")
                                            .Bold();
                                    });
                                    ...
                                    foreach (var point in ErrorWith3D)
                                    {
                                        ...
                                        table
                                            ...
                                            .Element(
                                                ExceededTolerance
                                                    ? BlockBodyExceededTolerance
                                                    : BlockBody
                                            )
                                            .Text(point.PointID.ToString());
                                        table
                                            .Cell()
                                            .Element(
                                                ExceededTolerance
                    ...
                    static QuestPDF.Infrastructure.IContainer BlockHeader(
                    ...
                    static QuestPDF.Infrastructure.IContainer BlockTableHeader(
                        QuestPDF.Infrastructure.IContainer container
                    )
                    {
                        return container
                    ...
                    static QuestPDF.Infrastructure.IContainer BlockBody(
                        QuestPDF.Infrastructure.IContainer container
                    )
                    {
                        return container
                    ...
                    static QuestPDF.Infrastructure.IContainer BlockBodyExceededTolerance(
                        QuestPDF.Infrastructure.IContainer container
                    )
                    {
                        return container
